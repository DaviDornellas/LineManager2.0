...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Verifica se está fora da página de login ou cadastro
    if (pathname !== "/authentication/sign-in" && pathname !== "/authentication/sign-up") {
      fetchProfile(); // Executa logo de cara

      const intervalId = setInterval(fetchProfile, 0.3 * 60 * 1000); // A cada 5 minutos
